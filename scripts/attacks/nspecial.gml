...
set_attack_value(AT_NSPECIAL, AG_SPRITE, sprite_get("AT_NSPECIAL"));
set_attack_value(AT_NSPECIAL, AG_NUM_WINDOWS, 5);
set_attack_value(AT_NSPECIAL, AG_HAS_LANDING_LAG, 4);
set_attack_value(AT_NSPECIAL, AG_OFF_LEDGE, 1);
set_attack_value(AT_NSPECIAL, AG_AIR_SPRITE, sprite_get("AT_NSPECIAL"));
set_attack_value(AT_NSPECIAL, AG_HURTBOX_SPRITE, sprite_get("AT_NSPECIAL_hurt"));
