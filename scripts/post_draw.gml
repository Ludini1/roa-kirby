...
draw_sprite_ext(sprite_get("AT_NSPECIAL_ZETT_UNCHRG_FG"),window_timer / 3.3,x-12,y,1,1,bash_angle-45,c_white,1)
}
if (attack == AT_NSPECIAL_ZET) and (window == 3) and ((state == PS_ATTACK_AIR) or (state == PS_ATTACK_GROUND)){
draw_sprite_ext(sprite_get("AT_NSPECIAL_ZETT_UNCHRG_FG"),window_timer / 3.3,x-16,y,1,1,bash_angle-45,c_white,1)
}