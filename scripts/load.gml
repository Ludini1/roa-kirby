...
sprite_change_offset("AT_DATTACK", 72, 82);
sprite_change_offset("AT_DATTACK_AIR", 72, 82);
...
sprite_change_offset("AT_NSPECIAL", 60, 84);
sprite_change_offset("AT_FSPECIAL_AIR", 44, 92);
sprite_change_offset("AT_USPECIAL", 64, 88);
sprite_change_offset("AT_DSPECIAL_CHARGE", 60, 88);
sprite_change_offset("AT_DSPECIAL_NOCHARGE", 60, 88);
sprite_change_offset("AT_DSPECIAL_MEDCHARGE", 60, 88);
sprite_change_offset("AT_DSPECIAL_FULLCHARGE", 60, 88);
